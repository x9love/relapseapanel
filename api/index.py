...
def add_default_admin():
    ...
    try:
        ...
        logger.error(f"Failed to add default admin: {e}")
        raise
...
def deactivate_key():
    ...
    try:
        ...
        logger.error(f"Failed to deactivate key: {e}")
        return jsonify({'error': 'Internal server error'}), 500
...
def get_loader_version():
    ...
    try:
        ...
        logger.error(f"Failed to get loader version: {e}")
        return jsonify({'error': 'Internal server error'}), 500
...
def update_loader_version():
    ...
    try:
        ...
        logger.error(f"Failed to update loader version: {e}")
        return jsonify({'error': 'Internal server error'}), 500
...
def login():
    if request.method == 'POST':
        ...
        try:
            ...
            logger.error(f"Failed to process login: {e}")
            return jsonify({'error': 'Internal server error'}), 500
...
def admin_panel():
    ...
    try:
        ...
        <head>
            ...
            <script>
                ...
                window.onload = function() {
                    ...
                    .catch(error => {
                        console.error('Error fetching loader version:', error);
                    });
                    openTab('keys');
                }
            </script>
        ...
        logger.error(f"Failed to render admin panel: {e}")
        return jsonify({'error': 'Internal server error'}), 500
